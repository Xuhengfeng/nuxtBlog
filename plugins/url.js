...
let _host= localhostDev ? 'http://112.74.181.229:7031/custAppApi' : 'http://custapi.shyj.cn/custAppApi';
...
let URL = {
	...
	HOUSE_AGENCYAPPLY_HOUSE:_host + "/loanAgencyApplyRest/loanAgency",//代办业务申请
	...
	INFOQUERY:_host + "/info/query/",               //获取资讯内容信息列表
	INFO:_host + "/info/",               //获取资讯详情
